...
Anvil exposes custom RPC methods beyond the standard Ethereum JSON-RPC API. These methods are useful for testing scenarios that require account impersonation, time manipulation, or mining control. This page covers the most common workflows; for every custom method with parameters and examples, see the [complete RPC method reference](/anvil/rpc-methods).
